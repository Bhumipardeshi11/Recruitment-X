        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="flex-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 placeholder:text-slate-400 outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-100"
              />
            </div>
          </div>
          ...
          <div className="sm:pt-7">
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold shadow-md disabled:opacity-60"
            >
              {loading ? (
                <>
          ...
          <div className="mt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {projects.map((project) => (
                <div
                  key={project.id}
                  className="border border-slate-200 rounded-2xl p-5 bg-white hover:border-violet-300 hover:shadow-lg transition-all"
                >
