...
export class JobService {
  static async createJob(recruiterId: string, data: {
    title: string;
    company: string;
    department?: string;
    location: string;
  ...
  static async getAllJobs(filters?: { query?: string; location?: string }) {
  ...
  static async createMatch(candidateId: string, jobId: string, resumeId?: string, matchData?: { matchPercentage: number; fitSummary?: string }) {
