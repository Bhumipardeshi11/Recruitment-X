...
export class AiService {
   ...
   */
  static async generateCoverLetter(resumeSummary: string, jobTitle: string, companyName: string, jdDescription: string): Promise<string> {
    if (this.genAi) {
      try {
...
Candidate`;
   ...
   */
  static async enhanceBulletPoints(rawBullets: string[], targetRole?: string): Promise<string[]> {
   ...
   */
  static async generateInterviewPrep(roleTitle: string, techStack: string[]) {
    return [
      {
